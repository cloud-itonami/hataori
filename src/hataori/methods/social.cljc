...
(defn draft-observation-post
  "A dry-run observation post over hataori's own domain (Garment / apparel robotics — cut-make-trim automation to END the sweatshop, not out-compete it (ISIC C13-14 / ISCO 7531,8219 / UNSPSC 53).…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "hataori R0: live social posting is Council Lv6+ + operator + "
